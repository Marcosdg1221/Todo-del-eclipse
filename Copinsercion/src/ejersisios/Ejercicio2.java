...
public class Ejercicio2 {
	public static void main(String[] args) {
		...
		/*
		 * Las variables que crees en el for, no deberías poner un cambio de este dentro
		 * de las operaciones del for, si no dentro de () Deberían usar las variables al
		 * revés (Pos++ y posit1++ están a la reversa
		 */
		int tabla[] = new int[20];
		int tabla2[] = new int[20];
		int pares[] = new int[20]; // tabla solo pares
		int impares[] = new int[20]; // tabla solo impares
		...
		for (int pos = 0; pos < 20; pos++) { // Guardan en dos tablas distintas los pares y los impares
		...
		for (; guardarcpar < 20; guardarcpar++, cero++) { // Sólo te falta esto, imprimir los impares desde su espacio 0
															// (de la tabla impares) a la tabla2
